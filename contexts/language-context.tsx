...
,
    ...
    'portal.login.error.linkExpired': 'Link verlopen',
    'portal.login.error.linkExpiredDescription': 'De inloglink is verlopen of ongeldig. Vraag een nieuwe link aan via "Wachtwoord vergeten" of log in met uw wachtwoord.',
    'portal.login.error.emailNotConfirmed': 'Controleer uw e-mail voor een bevestigingslink.',
    'portal.login.error.invalidCredentials': 'Ongeldig e-mailadres of wachtwoord. Als u bent uitgenodigd, gebruik dan de uitnodigingslink uit uw e-mail.',
    ...
    'portal.resetPassword.success.inviteAccepted': 'Wachtwoord ingesteld! U heeft nu toegang tot het portaal.',
    'portal.resetPassword.firstLoginTitle': 'Stel uw wachtwoord in',
    'portal.resetPassword.firstLoginDescription': 'Welkom! Voor uw eerste login moet u een nieuw wachtwoord instellen. Dit is verplicht voordat u toegang krijgt tot het portaal.',
    'portal.resetPassword.inviteDescription': 'U bent uitgenodigd! Stel uw wachtwoord in om te beginnen.',
    ...
    'portal.error.linkInvalid': 'Inloglink ongeldig',
    'portal.error.linkExpired': 'Deze inloglink is verlopen of ongeldig. Vraag een nieuwe link aan.',
    'portal.error.accessDenied': 'Toegang geweigerd. De link is mogelijk verlopen of ongeldig.',
    'portal.error.loginFailed': 'Fout',
    'portal.error.loginFailedDescription': 'Kon niet inloggen. Probeer opnieuw.',
    'portal.error.generic': 'Er is een fout opgetreden bij het inloggen.',
    'portal.welcome.firstLogin.title': 'Welkom bij Finit Solutions!',
    'portal.welcome.firstLogin.description': 'Uw account is succesvol aangemaakt. U kunt nu gebruik maken van alle functies van het portaal.',
  ...
  en: {
    ...
    'portal.login.error.linkExpired': 'Link Expired',
    'portal.login.error.linkExpiredDescription': 'The login link has expired or is invalid. Request a new link via "Forgot password" or sign in with your password.',
    'portal.login.error.emailNotConfirmed': 'Please check your email for a confirmation link.',
    'portal.login.error.invalidCredentials': 'Invalid email or password. If you were invited, please use the invite link from your email.',
    ...
    'portal.resetPassword.success.inviteAccepted': 'Password set successfully! You can now access the portal.',
    'portal.resetPassword.firstLoginTitle': 'Set Your Password',
    'portal.resetPassword.firstLoginDescription': 'Welcome! For your first login, you must set a new password. This is required before you can access the portal.',
    'portal.resetPassword.inviteDescription': 'You\'ve been invited! Please set your password to get started.',
    ...
    'portal.error.linkInvalid': 'Login Link Invalid',
    'portal.error.linkExpired': 'This login link has expired or is invalid. Please request a new link.',
    'portal.error.accessDenied': 'Access denied. The link may have expired or is invalid.',
    'portal.error.loginFailed': 'Error',
    'portal.error.loginFailedDescription': 'Could not log in. Please try again.',
    'portal.error.generic': 'An error occurred while logging in.',
    'portal.welcome.firstLogin.title': 'Welcome to Finit Solutions!',
    'portal.welcome.firstLogin.description': 'Your account has been successfully created. You can now use all portal features.',
