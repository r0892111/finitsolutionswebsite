          ...
          <button
            ...
            onClick={() => {
              ...
              pushEvent("cta_click", {
                ...
                location: "lp_installateurs_mobile_nav",
              });
            }}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  pushEvent("cta_click", {
                    ...
                    location: "lp_installateurs_hero",
                  });
                }}
            ...
            <div className="space-y-0">
              {(() => {
                ...
                return storyLines.map((line, index) => {
                  ...
                  // Determine if this item should have a connector line below it
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Connector line between icons (not above first, not below last, not through break) */}
                      {showConnectorBelow && (
        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          >
            ...
            <p className="text-[#1A2D63]/60 text-lg md:text-xl max-w-xl mx-auto">
              AI neemt het repetitieve werk over. Jij blijft installateur.
            </p>
          </motion.div>
            ...
            <button
              ...
              onClick={() => {
                ...
                pushEvent("cta_click", {
                  ...
                  location: "lp_installateurs_solutions",
                });
              }}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[#1A2D63] font-medium text-[15px] leading-snug">
                  En alles wat repetitief is in jouw installatiebedrijf
                </p>
        ...
        <div className="max-w-[900px] mx-auto relative z-10">
          ...
          >
            <blockquote className="font-newsreader text-lg md:text-xl text-white/80 italic leading-relaxed max-w-lg mx-auto">
              &ldquo;Ik ben installateur geworden om te installeren. Niet om achter een bureau te zitten.&rdquo;
            </blockquote>
          </motion.div>
        </div>
      </section>
          ...
          <div className="relative">
            ...
            >
              <h2 className="font-newsreader text-3xl md:text-4xl lg:text-5xl text-[#1A2D63] mb-4">
                Wil je weten wat mogelijk is voor jouw installatiebedrijf?
              </h2>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  pushEvent("cta_click", {
                    ...
                    location: "lp_installateurs_final_cta",
                  });
                }}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    pushEvent("cta_click", {
                      ...
                      location: "lp_installateurs_footer",
                    });
                  }}
          ...
          <button
            ...
            onClick={() => {
              ...
              pushEvent("cta_click", {
                ...
                location: "lp_installateurs_sticky",
              });
            }}
