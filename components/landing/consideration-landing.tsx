...
const recognitionItems: RecognitionItem[] = [
  { icon: FileText, text: "Offertes blijven liggen omdat je er simpelweg geen tijd voor hebt." },
  { icon: Inbox, text: "Je inbox zit vol aanvragen die nog opgevolgd moeten worden." },
  { icon: Receipt, text: "Offertes worden pas verstuurd wanneer het eigenlijk al te laat is." },
  { icon: Users, text: "Groeien betekent nu vooral: extra mensen aannemen." },
  { icon: CalendarX, text: "Je planning verandert dagelijks door last-minute administratie." },
  { icon: TimerOff, text: "Je reageert te traag op aanvragen — en merkt dat klanten intussen elders tekenen." },
];
...
const solutions: Solution[] = [
  {
    icon: Eye,
    title: "Volledige transparantie vanaf dag \u00e9\u00e9n",
    description: "Je weet precies wat we bouwen, hoe lang het duurt en wat het kost. Geen verrassingen. Geen kleine lettertjes.",
  },
  {
    icon: Shield,
    title: "We testen tot het werkt",
    description: "We blijven testen tot alles perfect draait. Jij hoeft nergens naar om te kijken.",
  },
  {
    icon: HeartHandshake,
    title: "Geen lange contracten",
    description: "We beginnen klein. Eén concreet project, snel opgeleverd. Zo zie je meteen wat het oplevert — zonder meteen een groot budget vast te leggen.",
  },
];
    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1A2D63] font-instrument selection:bg-[#B8C5E6] selection:text-[#1A2D63] overflow-x-hidden">
          ...
          <div className="relative z-10 text-center max-w-5xl">
            ...
            >
              <h1 className="font-newsreader text-5xl lg:text-6xl xl:text-[4.25rem] leading-[1.1] tracking-tight text-[#1A2D63]">
                Je weet dat AI bestaat, maar hoe zet je het in{" "}
                <span className="relative inline-block">
                  <span className="relative z-10">voor je bedrijf?</span>
                  <svg
            ...
            >
              Wij bekijken samen hoe jouw bedrijf vandaag werkt en bouwen AI-oplossingen op maat die terugkerende taken automatisch uitvoeren. 
            </motion.p>
            ...
            {/* 3 value bullets */}
            <motion.div
              className="flex flex-row items-center justify-center gap-6 text-[#1A2D63]/70 text-base max-w-4xl mx-auto"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.7 }}
            >
              <span className="flex items-center gap-2 whitespace-nowrap">
                <HandDrawnCheck className="w-5 h-5 flex-shrink-0" />
        ...
        <div className="md:hidden relative z-10 px-4 sm:px-6 pt-28 pb-6">
          <div className="text-center max-w-[22rem] sm:max-w-[28rem] mx-auto">
            <motion.h1
              ...
              transition={{ duration: 0.6, delay: 0.1 }}
            >
              Je weet dat AI bestaat. Maar hoe implementeer je het{" "}
              <span className="relative inline-block">
                <span className="relative z-10">in je bedrijf?</span>
                <svg
                  className="absolute -bottom-1 left-0 w-full h-[0.35em] z-0"
                  viewBox="0 0 200 20"
                  preserveAspectRatio="none"
            ...
            >
              ...
              <span className="flex items-center gap-2.5">
                <HandDrawnCheck className="w-6 h-6 flex-shrink-0" />
                We bouwen en integreren het met je huidige tools
              </span>
            </motion.div>
          </div>
        </div>
            ...
            {recognitionItems.map((item, index) => (
              ...
              >
                <div className="w-12 h-12 md:w-14 md:h-14 shrink-0">
                  <item.icon className="w-full h-full text-[#1A2D63]" strokeWidth={1.5} />
                </div>
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          >
            <h2 className="font-newsreader text-3xl sm:text-4xl md:text-5xl text-[#1A2D63] leading-[1.15] mb-4">
              Normale werknemer vs{" "}
              <span className="relative inline-block">
                <span className="relative z-10">AI-werknemer</span>
                <svg
                  className="absolute -bottom-1 left-0 w-full h-[0.35em] z-0"
                  viewBox="0 0 200 20"
                  preserveAspectRatio="none"
          ...
          <motion.div
            className="rounded-2xl border border-[#1A2D63]/[0.08] shadow-lg overflow-hidden"
            initial={{ opacity: 0, y: 25 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-40px" }}
            transition={{ duration: 0.5 }}
          >
            ...
            <div className="grid grid-cols-3">
              ...
              <div className="bg-[#F6F5F1] p-2 sm:p-4 md:p-5 text-center flex items-center justify-center">
                <span className="text-[10px] sm:text-xs uppercase tracking-wider font-semibold text-[#1A2D63]/50">
                  Traditioneel
                </span>
              </div>
              <div className="p-2 sm:p-4 md:p-5 text-center bg-[#1A2D63] flex items-center justify-center">
                <span className="text-[10px] sm:text-xs uppercase tracking-wider font-semibold text-white">
                  Onze AI-werknemers
                </span>
              </div>
            </div>
            ...
            {/* Table rows */}
            {[
              { aspect: "Kosten", traditional: "~€50.000/jaar", ai: "Fractie van een parttime medewerker, terugverdiend in maanden" },
              { aspect: "Beschikbaarheid", traditional: "8u/dag, 5d/week", ai: "24/7, 365 dagen" },
              { aspect: "Vakantie", traditional: "4 weken/jaar", ai: "Nooit" },
              { aspect: "Ziekteverzuim", traditional: "10 dagen/jaar", ai: "Nooit" },
              { aspect: "Opstarttijd", traditional: "3-6 maanden", ai: "2-4 weken" },
              { aspect: "Schalen?", traditional: "Nieuwe vacature", ai: "We bouwen gewoon een nieuwe werknemer" },
            ].map((row, index) => (
              <div
                key={index}
                className="grid grid-cols-3 border-t border-[#1A2D63]/[0.06]"
              >
                <div className="flex items-center p-2 sm:p-4 md:p-5">
                  <span className="font-newsreader text-[11px] sm:text-sm md:text-lg font-bold text-[#1A2D63]/80">{row.aspect}</span>
                </div>
                <div className="bg-[#F6F5F1] p-2 sm:p-4 md:p-5 flex items-center justify-center text-center">
                  <span className="text-[10px] sm:text-sm md:text-[15px] text-[#1A2D63]/65 leading-tight">{row.traditional}</span>
                </div>
                <div className="p-2 sm:p-4 md:p-5 flex items-center justify-center text-center">
                  <span className="text-[10px] sm:text-sm md:text-[15px] font-semibold text-[#1A2D63] leading-tight">{row.ai}</span>
                </div>
              </div>
            ))}
          </motion.div>
      ...
      >
        <div className="max-w-[1100px] mx-auto">
          ...
          >
            <h2 className="font-newsreader text-3xl sm:text-4xl md:text-5xl text-[#1A2D63] leading-[1.15] mb-4">
              Hoe wij de juiste keuze{" "}
              <span className="relative inline-block">
                <span className="relative z-10">makkelijk maken</span>
                <svg
                  className="absolute -bottom-1 left-0 w-full h-[0.35em] z-0"
                  viewBox="0 0 200 20"
                  preserveAspectRatio="none"
            ...
            <button
              ...
              onClick={() => {
                ...
                pushEvent("cta_click", {
                  ...
                  location: "lp_consideration_process",
                });
              }}
