        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          >
            ...
            <p className="text-[#1A2D63]/60 text-lg md:text-xl max-w-xl mx-auto">
              AI neemt het repetitieve werk over. Jij blijft elektricien.
            </p>
          </motion.div>
        ...
        <div className="max-w-[900px] mx-auto relative z-10">
          ...
          >
            <blockquote className="font-newsreader text-lg md:text-xl text-white/80 italic leading-relaxed max-w-lg mx-auto">
              &ldquo;Ik ben elektricien geworden om problemen op te lossen. Niet om achter een bureau te zitten.&rdquo;
            </blockquote>
          </motion.div>
        </div>
      </section>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  pushEvent("cta_click", {
                    ...
                    location: "lp_elektriciens_final_cta",
                  });
                }}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    pushEvent("cta_click", {
                      ...
                      location: "lp_elektriciens_footer",
                    });
                  }}
          ...
          <button
            ...
            onClick={() => {
              ...
              pushEvent("cta_click", {
                ...
                location: "lp_elektriciens_sticky",
              });
            }}
