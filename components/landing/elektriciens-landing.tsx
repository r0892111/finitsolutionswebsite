...
const painPoints: PainPoint[] = [
  { icon: FileText, text: "Offertes die dagen blijven liggen terwijl jij op de werf staat" },
  { icon: Clock, text: "Werkbonnen die je 's avonds nog moet invullen" },
  { icon: CalendarCheck, text: "Planning die elke week opnieuw een puzzel is" },
  { icon: RefreshCw, text: "Klanten die je drie keer moet opbellen voor opvolging" },
  { icon: Users, text: "Groeien lukt niet zonder extra administratief personeel" },
  { icon: TrendingDown, text: "Klussen mislopen omdat je te laat reageert" },
];
...
const solutions: Solution[] = [
  {
    icon: FileText,
    title: "Offertes gaan de deur uit terwijl jij bedrading trekt",
    description: "Klant vraagt een prijs? Je systeem maakt de offerte op basis van je standaardprijzen. Verstuurd binnen minuten. Zonder dat jij je handen vuil maakt aan papierwerk.",
  },
  {
    icon: CalendarCheck,
    title: "Je planning regelt zichzelf",
    description: "Klanten kiezen zelf een moment dat past. Bevestiging, herinnering en routeplanning gaan automatisch. Geen heen-en-weer gebel meer.",
  },
  {
    icon: RefreshCw,
    title: "Geen klant valt nog tussen de mazen",
    description: "Na elke klus: automatische werkbon, factuur en opvolgmail. Onderhoudstermijnen worden bijgehouden. Zonder dat jij eraan moet denken.",
  },
];
...
const storyLines: StoryLine[] = [
  { icon: Clock, text: "Je bent op locatie bij een klant." },
...
export function ElektriciensLanding() {
    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1A2D63] font-instrument selection:bg-[#B8C5E6] selection:text-[#1A2D63] overflow-x-hidden">
          ...
          <button
            ...
            onClick={() => {
              ...
              pushEvent("cta_click", {
                ...
                location: "lp_elektriciens_mobile_nav",
              });
            }}
      ...
      >
        ...
        <div className="hidden md:flex container mx-auto px-4 sm:px-6 md:px-10 lg:px-12 xl:px-16 items-center justify-center pt-28 lg:pt-32 pb-8 w-full relative z-10">
          ...
          <div className="relative z-10 text-center max-w-5xl">
            ...
            >
              Wij automatiseren de administratie van elektriciens. Offertes, werkbonnen, planning en opvolging draaien op de achtergrond. Jij doet waar je goed in bent.
            </motion.p>
            ...
            <motion.div
              className="flex flex-col items-start gap-2 text-[#1A2D63]/70 text-lg mx-auto w-fit text-left"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <div className="md:hidden relative z-10 px-4 sm:px-6 pt-28 pb-6">
          <div className="text-center max-w-[22rem] sm:max-w-[28rem] mx-auto">
            ...
            <motion.p
              ...
              transition={{ duration: 0.6, delay: 0.3 }}
            >
              Wij automatiseren de administratie van elektriciens. Offertes, werkbonnen, planning en opvolging draaien op de achtergrond.
            </motion.p>
            ...
            <motion.div
              className="flex flex-col items-start gap-2.5 text-[#1A2D63]/70 text-base mx-auto w-fit text-left"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.7 }}
            >
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          >
            ...
            <p className="text-[#1A2D63]/60 text-lg md:text-xl max-w-xl mx-auto">
              AI neemt het repetitieve werk over. Jij blijft op de werf.
            </p>
          </motion.div>
            ...
            <button
              ...
              onClick={() => {
                ...
                pushEvent("cta_click", {
                  ...
                  location: "lp_elektriciens_solutions",
                });
              }}
      ...
      >
        <div className="max-w-[1100px] mx-auto">
          ...
          >
            <h2 className="font-newsreader text-3xl sm:text-4xl md:text-5xl text-[#1A2D63] leading-[1.15] mb-4">
              Hoe je meer tijd op de werf{" "}
              <span className="relative inline-block">
                <span className="relative z-10">krijgt</span>
                <svg
                  className="absolute -bottom-1 left-0 w-full h-[0.35em] z-0"
                  viewBox="0 0 200 20"
                  preserveAspectRatio="none"
            ...
            <button
              ...
              onClick={() => {
                ...
                pushEvent("cta_click", {
                  ...
                  location: "lp_elektriciens_process",
                });
              }}
          ...
          >
            ...
            <div className="text-center md:text-left">
              <blockquote className="font-instrument text-lg md:text-xl text-white leading-relaxed mb-3">
                &ldquo;Ik spreek mijn administratie gewoon in via WhatsApp en alles verschijnt automatisch in mijn CRM. Enorme tijdswinst.&rdquo;
              </blockquote>
