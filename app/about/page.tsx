  ...
  return (
    <main className="pt-20 bg-finit-aurora min-h-screen font-general-sans">
      ...
      <Dialog open={!!selectedMember} onOpenChange={() => setSelectedMember(null)}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto bg-finit-aurora border border-white/30 shadow-2xl">
          {selectedMember && (
            <motion.div
            ...
            >
              ...
              <div className="space-y-8">
                {/* Quote */}
                <div className="bg-white/15 backdrop-blur-xl rounded-2xl p-6 border border-white/25 shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-white/90 finit-body">
