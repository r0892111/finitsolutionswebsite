          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {team.map((member, index) => (
              <motion.div
                ...
                className="group"
              >
                <Card className="h-full bg-white/90 backdrop-blur-xl border border-gray-200 shadow-xl hover:shadow-lg transition-shadow duration-200 overflow-hidden relative hover:-translate-y-1">
                  ...
                  <CardContent className="p-10 relative z-10">
                    ...
                    <div className="flex items-center justify-center">
                      <a 
                        ...
                        className="text-gray-800 hover:text-primary transition-colors duration-150 p-2 rounded-lg hover:bg-gray-100"
