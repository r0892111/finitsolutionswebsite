      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <span className="text-base font-light tracking-wide">{t('hero.scroll')}</span>
              <motion.div
                animate={{ y: [0, 8, 0] }}
                  ...
                  <div className="space-y-8">
                    <div className="inline-flex items-center gap-4 px-6 py-3 rounded-2xl bg-white/20 backdrop-blur-sm border border-white/30 shadow-xl step-number-marker">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-white/70">{t(`steps.${step.id}.subtitle`)}</div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {t.raw(`steps.${step.id}.details`).map((detail: string, i: number) => (
                        <motion.div
                          key={i}
                          initial={{ opacity: 0, y: 20 }}
                          whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <div className="relative">
                    <div className="bg-white/15 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/25">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <h4 className="text-lg font-bold text-white">{t('clientcase')}</h4>
                      </div>
                      <p className="text-white/90 italic leading-relaxed mb-6">&ldquo;{t(`steps.${step.id}.usecase`)}&rdquo;</p>
