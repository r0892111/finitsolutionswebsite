...
import { Search, Lightbulb, Code, TestTube, Rocket, ChevronRight, Cog, ChevronDown, CheckCircle2, ArrowRight, Clock, Users, TrendingUp, BarChart3, Shield, Zap, Target } from "lucide-react";
...
const processSteps = [
  {
    ...
    description: "Uitgebreide analyse van bedrijfsprocessen om optimalisatiekansen en technische vereisten te identificeren.",
    icon: Search,
    ...
    useCase: "Document opvraging over 15+ systemen kostte 4 uur per dag per advocaat",
    solution: "Geünificeerde kennisarchitectuur met intelligente zoekmogelijkheden",
  ...
  },
  {
    ...
    description: "Ontwerpen van schaalbare, veilige systemen die naadloos integreren met uw bestaande infrastructuur.",
    icon: Lightbulb,
    ...
    useCase: "Complexe juridische terminologie vereiste natuurlijke taalverwerking mogelijkheden",
  ...
  },
  {
    ...
    description: "Bouwen van robuuste, schaalbare oplossingen met enterprise-grade beveiliging en prestatie optimalisatie.",
    icon: Code,
    ...
    useCase: "Verwerking van 10TB juridische documenten met sub-seconde query response vereisten",
    solution: "Gedistribueerde verwerking met intelligente caching en edge optimalisatie",
  ...
  },
  {
    ...
    description: "Rigoureuze test protocollen die foutloze prestaties en gebruikerservaring optimalisatie garanderen.",
    icon: TestTube,
    ...
    useCase: "Bereiken van 99.5%+ nauwkeurigheid voor juridische document analyse in productie omgeving",
    solution: "Multi-laagse validatie met AI model fine-tuning en menselijk toezicht",
  ...
  },
  {
    ...
    description: "Strategische deployment met doorlopende prestatie monitoring en continue verbeteringscycli.",
    icon: Rocket,
    ...
    useCase: "Naadloze adoptie over 120 advocaten zonder productiviteit verstoring",
    solution: "Champion-geleide uitrol met uitgebreide training en ondersteuning systemen",
    outcome: "95% adoptie rate binnen 3 weken, 45-minuut naar 3-minuut query reductie",
    visual: "launch",
    metrics: {
      adoption: "95%",
      timeReduction: "93%",
    ...
    switch (stepId) {
        ...
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-3">
              {["Versnipperde informatie", "Handmatige processen", "Inefficiënte workflows"].map((item, i) => (
                <motion.div 
                  key={i}
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-semibold text-blue-800">Analyse Resultaat</span>
              </div>
              <p className="text-blue-700 text-sm">Identificatie van 12 kritieke verbeterpunten met geschat ROI van €240K/jaar</p>
            </div>
          </div>
        );
      case 2:
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-3">
              {["API Design", "Database Schema", "Security Layer", "UI/UX Flow", "Integration Map", "Deployment Plan"].map((tag, i) => (
                <motion.div 
                  key={i}
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-lg">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-semibold text-amber-800">Architectuur Blueprint</span>
              </div>
              <p className="text-amber-700 text-sm">Modulaire microservices architectuur met 99.9% uptime garantie</p>
            </div>
          </div>
        );
      case 3:
          ...
          <div className="space-y-4">
            <div className="rounded-lg bg-slate-900 text-slate-200 text-sm font-mono p-6 border border-slate-700 shadow-lg">
              ...
              <div className="space-y-2">
                ...
                >
                  <span className="text-green-400">function</span> <span className="text-blue-300">ingestDocuments</span>() <span className="text-gray-400">{`{ ✓ }`}</span>
                </motion.div>
                <motion.div 
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                ...
                >
                  <span className="text-green-400">function</span> <span className="text-blue-300">buildSearchIndex</span>() <span className="text-gray-400">{`{ ✓ }`}</span>
                </motion.div>
                <motion.div 
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                ...
                >
                  <span className="text-green-400">function</span> <span className="text-blue-300">deployChatInterface</span>() <span className="text-gray-400">{`{ ✓ }`}</span>
                </motion.div>
                <motion.div 
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                ...
                >
                  <span className="text-purple-300">rag</span>.<span className="text-yellow-300">generateResponse</span>(query, context)
                </motion.div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-green-800 text-sm">Backend API</span>
                </div>
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-blue-800 text-sm">Frontend UI</span>
                </div>
      ...
      case 4:
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              {["Security Audit", "Performance Test", "User Acceptance", "Load Testing"].map((test, i) => (
                <motion.div 
                  key={i}
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                ...
                >
                  ...
                  <span className="text-green-800 font-medium text-sm">{test}</span>
                </motion.div>
              ))}
            </div>
            <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-violet-50 border border-purple-200 rounded-lg">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-semibold text-purple-800">Test Resultaten</span>
              </div>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  <div className="text-lg font-bold text-purple-700">&lt;200ms</div>
    ...
    <main className="bg-finit-aurora min-h-screen">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            Van Idee tot <span className="font-light bg-gradient-to-r from-yellow-200 via-white to-yellow-200 bg-clip-text text-transparent">Impact</span>
          </motion.h1>
          ...
          >
            Digitale ambities omzetten in meetbare bedrijfsresultaten door methodische excellentie en innovatieve engineering.
          </motion.p>
              ...
              {processSteps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Step Icon */}
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${step.accent} flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 mb-4 mx-auto relative z-10`}>
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="text-white/80">{processSteps[activeStep - 1]?.subtitle}</div>
                            </div>
                          </div>
                          ...
                          <div className="space-y-4">
                            {processSteps[activeStep - 1]?.details.map((detail, i) => (
                              ...
                              >
                                ...
                                <span className="text-white/90 font-medium leading-relaxed">{detail}</span>
                              </motion.div>
                            ))}
                          </div>
                        </div>
                        ...
                        {processSteps[activeStep - 1]?.metrics && (
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                              {Object.entries(processSteps[activeStep - 1]?.metrics || {}).map(([key, value], i) => (
                                <motion.div
                                  key={key}
                                  initial={{ opacity: 0, scale: 0.8 }}
                                  animate={{ opacity: 1, scale: 1 }}
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl">
                          <div className="flex items-center gap-4 mb-6">
                            ...
                            <h3 className="text-2xl font-bold text-white">Juridisch Technologie Bedrijf</h3>
                          </div>
      ...
      <section className="py-20 md:py-32 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-extralight mb-8 text-white tracking-tight">
              Klaar voor <span className="font-light bg-gradient-to-r from-yellow-200 via-white to-yellow-200 bg-clip-text text-transparent">Excellentie</span>?
            </h2>
