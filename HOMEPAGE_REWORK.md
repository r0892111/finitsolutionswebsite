...
## Vierde ronde: twee sporen na de lesreeks (15 september 2026)

Beslist met Alex. Gaat voor op punt 1, 12, 15 en 18 waar ze botsen.

24. **De lesreeks blijft stap 1 voor iedereen.** Het eindrapport geeft een eerste indicatie welke weg past; in het strategiegesprek na de lesreeks leggen wij uit welke weg we aanraden. De criteria zijn niet zwart-wit. Niet de bezoeker kiest.
25. **Stap 2 splitst.** Het bouwpakket (€ 2.000 opstart) voor de meeste KMO's, of het AI-native traject voor ambitieuze ondernemers in sectoren waar het kan (meestal meerdere afdelingen, 15+ FTE): € 8.000 per maand excl. btw, alles inbegrepen, jaarcontract aan een vaste prijs, stoppen kan na 6 maanden, jaarlijks verlengbaar. "AI-native" wordt altijd in één zin uitgelegd; het traject is "Dé toekomst voor efficiënte KMO's".
26. **Stap 3 heet Gebruiken en is een licentie.** Bouwpakket: € 195 per maand. In het traject inbegrepen. Alle software en AI-werknemers blijven van Finit (zoals de algemene voorwaarden al zeggen); het fundament en de gegevens blijven van de klant en gaan mee bij stoppen. Het vak "Van jou, ook als je stopt" (de code mee) is vervangen door "Je fundament blijft van jou".
27. **"Stel je kandidaat"** gaat naar `/ai-native-traject#kandidaat` (`components/home/traject-pagina.tsx`, `kandidaat-formulier.tsx`), alles verplicht, via dezelfde Netlify Function met `soort: "kandidatuur"`.
28. **Nog open:** een minimum- of opzegtermijn voor de licentie van het bouwpakket ("maandelijks opzegbaar" is van de site gehaald tot dat vastligt); of het traject een opstartkost heeft (de site zegt "alles inbegrepen"); de nieuwe teksten van het traject en het paneel van stap 2 nalezen; de oude landingspagina's beschrijven nog het oude model.

## Vijfde ronde: de review van Alex op het playbook (15 september 2026, namiddag)

Transcript in `yap1536.md`. Gaat voor op punt 2, 7, 16, 24 tot 28 waar ze botsen. Het Finit Playbook (v0.2, in de Downloads-map van Alex) is vanaf nu de bron; de site volgt het playbook.

29. **Stap 1 heet de onboarding op Finit OS**, niet meer de lesreeks (werknaam: Alex zei "iets in de zin van de Finit OS onboarding of access"; de definitieve naam kiezen de oprichters). De klant koopt eenmalig toegang tot het platform, doorloopt daar de onboarding (de AI stelt vragen, hij praat) en krijgt op het einde een analyse met de AI-werknemers die het meest opleveren, ons advies, en een strategiegesprek van 90 minuten met Karel. Prijs onveranderd (€ 95 voor de eerste 20, daarna € 295). Vandaag draait de onboarding nog op Skool: de knop "Start je onboarding" gaat daarheen, en het Skool-blok zegt "Je onboarding, vandaag op Skool". Finit OS zelf (video's in de eigen frontend, opnames in de UI, nul technische setup) komt later.
30. **Finit OS is het platform van de klant**: zijn eigen instantie, met zijn company brain, het overzicht van al zijn AI-werknemers en hun logboek, aan- en uitzetten, zijn fundament bijvoeden zonder dat het rommelig wordt, en tickets indienen. "Voorrang bij vragen" (13/09) is daarin opgegaan.
31. **Bouwpakket**: voor kleinere KMO's, een vast aantal relatief eenvoudige AI-werknemers, bepaald in het strategiegesprek, in 2 tot 4 weken live. € 2.000 opstart, licentie € 195 per maand, per jaar getekend. Uitbreidingen aan het dagtarief van € 750; de licentie stijgt met 2% van de prijs van het meerwerk per maand (€ 2.000 meerwerk = € 40 per maand), exclusief rechtstreekse infrastructuurkosten. Ook een webshop of iets anders buiten het pakket kan zo, met de 2%-regel. Gesloten of maatwerksoftware zonder koppeling of export: buiten scope, uitzoeken; vaak raden we dan het traject aan.
32. **AI-native traject**: alleen voor KMO's met serieuze ambitie, gekwalificeerd tijdens de onboarding; we raden het niet zomaar aan. Inhoud: een centrale AI die alles aanstuurt, eigen software en koppelingen (ook betaalmuren), alle mailboxen en drives gekoppeld, AI die belt, alles onder één centraal systeem. € 8.000 per maand, alles inbegrepen (bouwen en onderhouden), getekend voor een jaar; tussen maand 6 en 12 van het eerste jaar kan de klant stoppen als hij niet tevreden is; daarna jaar per jaar. Op het einde is de klant een bedrijf dat op AI draait. Geen aparte opstartkost.
33. **Eigendom**: het fundament (de map met tekstbestanden over het bedrijf) is het enige waar de klant intellectueel recht op heeft; hij kan het altijd downloaden en lokaal houden. Alle koppelingen, AI-werknemers en IT-ontwikkeling zijn van Finit en draaien op de servers van Finit. Stopt de klant, dan verliest hij de AI-werknemers en zijn toegang tot Finit OS, en verwijdert Finit zijn gegevens van de eigen systemen.
34. **Positionering**: Finit is dé AI-partner voor KMO's bij hun overgang naar het AI-tijdperk. Al het handwerk van een KMO nemen AI-werknemers over die het bedrijf even goed kennen als de zaakvoerder. Liam hoort niet bij het team in het playbook. Bedrijfsgegevens en capaciteit blijven kort: het playbook gaat over de oplossingen.
35. **Nog open na deze ronde:** de definitieve naam van stap 1; wanneer de onboarding van Skool naar Finit OS verhuist; of de licentie van het bouwpakket binnen het jaar stopgezet kan worden; "elke maand een uur strategie" (13/09) bevestigen; wanneer de eigen infrastructuur en eigen modellen (Alex: in opbouw, volledig privé) publiek geclaimd mogen worden.

## Zesde ronde: "vanaf"-prijzen en het voorstel in het strategiegesprek (16 september 2026)

Transcript in `yap3.md` (Karel en Alex). Gaat voor op punt 25, 26 en 31 waar ze botsen. Nog in het playbook te verwerken (v0.2 zegt nog € 2.000 / € 195 / 2%).

36. **"Vanaf"-prijzen op de site.** Bouwpakket vanaf € 1.650 opstart, gebruikslicentie vanaf € 95 per maand (per jaar). Het minste dat je voor € 1.650 kunt laten bouwen is iets eenvoudigs, zoals een AI-werknemer op de mailbox die sorteert en antwoorden klaarzet (kost ons ± € 50, licentie € 95). Karels bezwaar (een zaakvoerder wil weten wat het kost) is beantwoord met: worst case € 95 voor de onboarding, daarna een gratis gesprek met een offerte, en pas dan engageert hij zich.
37. **Het voorstel komt in het strategiegesprek.** Na de onboarding boekt de klant het gesprek. Finit bereidt zich voor op het fundament (rapport, tiers, overzichten) en komt met een stappenplan en een voorstel: een basislicentie (infrastructuur, beheer) plus per AI-werknemer een opstartkost en een gebruikslicentie. De klant snoeit in overleg wat hij niet nodig heeft. Hoe meer een AI-werknemer overneemt, hoe meer systemen hij gebruikt en hoe meer waarde hij oplevert, hoe hoger de prijs; licenties kunnen oplopen tot € 750 à € 950 per maand.
38. **Tiers.** Drie tot vijf niveaus met een naam, elk een eigen ontwikkelprijs en een eigen licentieprijs (geen vast percentage): van een eenvoudige AI-werknemer met één taak, over AI-werknemers in meerdere systemen en deterministische koppelingen, tot orchestratie over alle systemen. De lijst wordt gemaakt bij de eerste klant die converteert en komt niet op de website; hij dient het salesgesprek. In de laatste module van de onboarding categoriseert ons framework de kansen al in tiers (de klant ziet dat nog niet).
39. **Maatwerk** (eigen CRM, webshop, website, koppelingen die er nog niet zijn): aparte scoping, dagtarief (€ 750, van 15/09) met een indicatie en een plafond vooraf; de gebruikslicentie ervoor staat in de offerte op maat (Karel opperde 5% van de ontwikkelprijs per maand; niet beslist). De 2%-regel van 15/09 is van de site.
40. **Nooit meer "onderhoud"**: het zijn gebruikslicenties. Op de site is elke "licentie" en "onderhoud(en)" vervangen door "gebruikslicentie" en "draaiend houden".
41. **Niet aangeraakt in dit gesprek:** het AI-native traject (€ 8.000 per maand) blijft staan zoals op 15/09. De prijs van de onboarding kan later omhoog (€ 300 tot € 500); de onboarding wordt korter (de mailbox-exports vallen weg). Het strategiegesprek moet het verhaal in waarde brengen (wat is een extra deal je waard), niet in functies.
42. **Nog open:** de tierlijst met namen en prijzen; het bedrag van de basislicentie; de licentie voor maatwerk; of € 2.000 en € 195 nog als vast pakket bestaan; het playbook naar v0.3.
43. **Het AI-native traject is geschrapt** (Alex, 16 september, na punt 41). Eén weg na de onboarding: het strategiegesprek, het voorstel per AI-werknemer, bouwen, live. De pagina `/ai-native-traject`, het kandidaatsformulier, de `soort: "kandidatuur"`-tak in de Netlify Function en de tekst `TRAJECT` in copy.ts zijn weg; de kaarten van stap 2 en 3 tonen weer één prijs ("vanaf"). Het paneel van stap 2 heet opnieuw "Nu het technische werk" met de intro van 13/09. Wat het traject beloofde (eigen software, orchestratie over alle systemen) valt nu onder maatwerk aan dagtarief of onder de bovenste tiers van het voorstel.

## Zevende ronde: terug naar de lesreeks, Finit OS van de site (18 september 2026)

Beslist door Alex. Gaat voor op punt 29, 30 en 35 waar ze botsen. De prijzen van 16/09 (punt 36 tot 43) blijven staan.

44. **Stap 1 heet opnieuw de lesreeks.** De werknaam "onboarding op Finit OS" (punt 29) is teruggedraaid. De knop heet weer "Start de lesreeks", de boodschap blijft "Leg jouw AI-fundament", het Skool-blok zegt weer "De lesreeks op Skool", de prijskaart van stap 1 heet weer "Lesreeks". Overal waar 15/09 "je onboarding" kwam, staat de tekst van vóór 15/09 terug; de zinnen die op 15 en 16/09 nieuw waren (strategiegesprek, voorstel, "vanaf"-prijzen) blijven en zeggen nu "de lesreeks".
45. **Finit OS staat niet meer op de site.** De naam is uit de hero, de pitch, stap 1, het paneel van stap 1 ("doet de AI nu met jou"), het paneel van stap 3, de FAQ, de bedankpagina en de footer. In het paneel van stap 3 is het vak "Alles in Finit OS" weg en staat "Voorrang bij vragen" (13/09) terug. De intake op `/intake` (het product zelf) heet nog Finit OS en is niet aangeraakt.
